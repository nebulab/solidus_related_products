...
FactoryBot.define do
  factory :relation, class: Spree::Relation do
    trait :from_product_to_product do
      ...
      association :relation_type, factory: :relation_type, traits: [:from_product_to_product]
    end

    trait :from_product_to_variant do
      association :relatable, factory: :product
      association :related_to, factory: :variant
      association :relation_type, factory: :relation_type, traits: [:from_product_to_variant]
    end

    trait :from_variant_to_product do
      association :relatable, factory: :variant
      association :related_to, factory: :product
      association :relation_type, factory: :relation_type, traits: [:from_variant_to_product]
    end

    trait :from_variant_to_variant do
      association :relatable, factory: :variant
      association :related_to, factory: :variant
      association :relation_type, factory: :relation_type, traits: [:from_variant_to_variant]
    end
